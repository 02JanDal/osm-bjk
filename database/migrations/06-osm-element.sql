...
CREATE INDEX IF NOT EXISTS element_tag_amenity_idx ON osm.element USING btree ((tags->>'amenity')) WHERE tags ? 'amenity';
CREATE INDEX IF NOT EXISTS element_tag_barrier_idx ON osm.element USING btree ((tags->>'barrier')) WHERE tags ? 'barrier';
CREATE INDEX IF NOT EXISTS element_tag_building_idx ON osm.element USING btree ((tags->>'building')) WHERE tags ? 'building';
CREATE INDEX IF NOT EXISTS element_tag_highway_idx ON osm.element USING btree ((tags->>'highway')) WHERE tags ? 'highway';
CREATE INDEX IF NOT EXISTS element_tag_landuse_idx ON osm.element USING btree ((tags->>'landuse')) WHERE tags ? 'landuse';
CREATE INDEX IF NOT EXISTS element_tag_natural_idx ON osm.element USING btree ((tags->>'natural')) WHERE tags ? 'natural';
